...
public class NotationQueueTest {
	...
	public double a1 = 1.1, b1 =2.1, c1 = 3.1, d1 = 4.1, e1 = 5.1, f1 = 6.1; 
	@Before
	...
	public void testDequeueStudent() {
		...
		try {
			assertEquals(a1, doubleQ.dequeue(), 0.0001);
			assertEquals(b1, doubleQ.dequeue(), 0.0001);
			assertEquals(c1, doubleQ.dequeue(), 0.0001);
			doubleQ.dequeue();
			assertTrue("This should have caused an QueueUnderflowException", false);
		}
		catch (QueueUnderflowException e){
