...
public class NotationStackTest {
	...
	public double a1 = 1.2, b1 = 1.3, c1 = 1.2, d1 = 94.3;
	@Before
	...
	public void testPushStudent() {
		...
		try {
			...
			assertEquals(true, doubleS.push(3.4));
			assertEquals(4, doubleS.size());
			assertEquals(true, doubleS.push(5.9));
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		assertEquals("1.21.31.2", doubleS.toString());
		try {
			doubleS.push(55.6);
		} catch (StackOverflowException e) {
			assertFalse("This should have caused an StackOverflowException", false);
		}
		assertEquals("1.21.31.255.6", doubleS.toString());
		try {
			doubleS.push(1.1);
		} catch (StackOverflowException e) {
			assertFalse("This should have caused an StackOverflowException", false);
		}
		assertEquals("1.21.31.255.61.1", doubleS.toString());
	}
