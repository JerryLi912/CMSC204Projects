...
public class PasswordCheckerTest {
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidePassword("abcABC12"));
			PasswordCheckerUtility.isValidePassword("abc12");
	...
	{
		try{
			assertTrue(PasswordCheckerUtility.isValidePassword("1234567aA"));
			PasswordCheckerUtility.isValidePassword("1234567a");
	...
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValidePassword("1234aaAA"));
	...
	public void testIsValidPasswordInvalidSequence()
	{
		try{
			assertEquals(true,PasswordCheckerUtility.isValidePassword("1234aaAA"));
			PasswordCheckerUtility.isValidePassword("1234aAAA");
	...
	public void testGetInvalidPasswords() {
		...
		assertFalse(nextResults.contains("more than two"));
		...
		scan = new Scanner(results.get(8)); //a
