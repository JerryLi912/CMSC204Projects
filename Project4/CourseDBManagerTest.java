...
public class CourseDBManagerTest {
	...
	public void testShowAll() {
		...
		assertEquals(list.get(0),"\nCourse:CMSC203 CRN:30503 Credits:4 Room:SC450 Instructor:Jill B. Who-Dunit");
		assertEquals(list.get(1),"\nCourse:CMSC203 CRN:30504 Credits:4 Room:SC450 Instructor:Joey Bag-O-Donuts");
		assertEquals(list.get(2),"\nCourse:CMSC204 CRN:30559 Credits:4 Room:SC450 Instructor:BillyBob Jones");
			}
	/**
