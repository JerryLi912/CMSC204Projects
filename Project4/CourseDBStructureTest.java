...
/**
 * This is the test file for the CourseDBStructure
 * which is implemented from the CourseDBStructureInterface
...
public class CourseDBStructureTest {
	...
	public void testHashTable()
	{
		...
		CourseDBElement cde = new CourseDBElement("CMSC500", 39999, 4, "SC130", "Nobody InParticular");
		cds.add(cde);
